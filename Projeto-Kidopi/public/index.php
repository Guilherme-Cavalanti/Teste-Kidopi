    ...
    <div class="container-fluid d-flex p-0">
        <div class="content container col-sm-12 col-lg-8  col-xl-6 d-block p-0 ps-5">
            ...
            <div class="container d-flex p-0 col-sm-12">
                <div class="row w-100">
                    <div class="col-xs-7 col-sm-7 mb-3">
                    ...
                    <div class="col-xs-6 col-sm-5 mb-3">
                        <button onclick="LoadData()"  class="btn btn-primary w-100">Buscar Dados</button>
                    </div>
                </div>
            </div>
            <div id="country_area"> 
            ...
            <div class="container-fluid p-0">
                <div class="row w-100">
                    <div class="col-xs-10 col-sm-11 mb-3">
                        <h3> Último acesso:</h3>    
                    </div>
                    <div class="col-xs-2 col-sm-1 mb-3">
            ...
            <div id="info" class="border container-fluid p-0"> 
